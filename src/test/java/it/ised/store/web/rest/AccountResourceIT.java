package it.ised.store.web.rest;

import it.ised.store.StoreApp;
import it.ised.store.config.Constants;
import it.ised.store.domain.User;
import it.ised.store.repository.AuthorityRepository;
import it.ised.store.repository.UserRepository;
import it.ised.store.security.AuthoritiesConstants;
import it.ised.store.service.UserService;
import it.ised.store.service.dto.PasswordChangeDTO;
import it.ised.store.service.dto.UserDTO;
import it.ised.store.web.rest.vm.KeyAndPasswordVM;
import it.ised.store.web.rest.vm.ManagedUserVM;
...
import static it.ised.store.web.rest.AccountResourceIT.TEST_USER_LOGIN;
