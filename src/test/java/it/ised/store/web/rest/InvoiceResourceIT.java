...
import it.ised.store.domain.Invoice;
import it.ised.store.repository.InvoiceRepository;
import it.ised.store.service.InvoiceService;
...
import it.ised.store.domain.enumeration.InvoiceStatus;
import it.ised.store.domain.enumeration.PaymentMethod;
/**
