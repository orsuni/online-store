...
import it.ised.store.config.audit.AuditEventConverter;
import it.ised.store.domain.PersistentAuditEvent;
...
import static it.ised.store.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
